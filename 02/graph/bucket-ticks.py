...
y = [0.0010686000, 0.0010567000, 0.0010660000, 0.0010264000, 0.0010187000, 0.0010312000, 0.0010518000]
label_x = ["data1.dat","data2.dat","data3.dat", "data4.dat", "data5.dat"]

plt.barh(x, y, align="center")           # 中央寄せで棒グラフ作成
plt.yticks(x, label_x)  # X軸のラベル

# plt.ylabel("データの種類") # x軸ラベル
# plt.xlabel("実行時間 [s]") # y軸ラベル
